--[[
 ...
 | '_ ` _ \ / _ \/ _ \ \ /\ / / '_ \ / _ \ / _ \| |/ /                                                         
 | | | | | |  __/ (_) \ V  V /| | | | (_) | (_) |   <                                                          
 |_| |_| |_|\___|\___/ \_/\_/ |_| |_|\___/ \___/|_|\_\          _                                              
     | |              | |                    | | | |           (_)                                             
   __| | _____   _____| | ___  _ __   ___  __| | | |__  _   _   _ _ __ ___   __ _ _ __ ___   ___  _____      __
  / _` |/ _ \ \ / / _ \ |/ _ \| '_ \ / _ \/ _` | | '_ \| | | | | | '_ ` _ \ / _` | '_ ` _ \ / _ \/ _ \ \ /\ / /
 | (_| |  __/\ V /  __/ | (_) | |_) |  __/ (_| | | |_) | |_| | | | | | | | | (_| | | | | | |  __/ (_) \ V  V / 
  \__,_|\___| \_/ \___|_|\___/| .__/ \___|\__,_| |_.__/ \__, | |_|_| |_| |_|\__,_|_| |_| |_|\___|\___/ \_/\_/  
                              | |                        __/ |                                                 
                              |_|                       |___/                                                  
...
KryptonConfiguration = {
	...
	RigName = "meowhook6krypton",
	Hats = {
        ["Right Arm"] = {
            {Texture = "120169691545791", Mesh = "117287001096396", Name = "Accessory (RARM)", Offset = CFrame.identity},
            {Texture = "136752500636691", Mesh = "125405780718494", Name = "Accessory (RArm)", Offset = CFrame.Angles(0,0,math.rad(-90))}
        },

        ["Left Arm"] = {
            {Texture = "120169691545791", Mesh = "117287001096396", Name = "Accessory (LARM)", Offset = CFrame.identity},
            {Texture = "136752500636691", Mesh = "125405780718494", Name = "Accessory (LArm)", Offset = CFrame.Angles(0,0,math.rad(-90))}
        },

        ["Right Leg"] = {
            {Texture = "131014325980101", Mesh = "121304376791439", Name = "Accessory (RightLeg)", Offset = CFrame.identity},
            {Texture = "136752500636691", Mesh = "125405780718494", Name = "Accessory (RLeg)", Offset = CFrame.Angles(0,0,math.rad(-90))}
        },

        ["Left Leg"] = {
            {Texture = "131014325980101", Mesh = "121304376791439", Name = "Accessory (LeftLeg)", Offset = CFrame.identity},
            {Texture = "136752500636691", Mesh = "125405780718494", Name = "Accessory (LLeg)", Offset = CFrame.Angles(0,0,math.rad(-90))}
        },
        
        ["Torso"] = {
            {Texture = "131014325980101", Mesh = "127552124837034", Name = "Accessory (Toorso)", Offset = CFrame.identity},
            {Texture = "70661572547971", Mesh = "110684113028749", Name = "Accessory (Black)", Offset = CFrame.identity}
        },
    },
...
KryptonConfiguration = {
	...
	Hats = {
        ["Right Arm"] = {
            {Texture = "83207562332062", Mesh = "138744606849121", Name = "Accessory (LimbOne)", Offset = CFrame.Angles(0,0,math.rad(-90))}
        },

        ["Left Arm"] = {
            {Texture = "83207562332062", Mesh = "138744606849121", Name = "Accessory (LimbTwo)", Offset = CFrame.Angles(0,0,math.rad(-90))}
        },

        ["Right Leg"] = {
            {Texture = "136752500636691", Mesh = "138744606849121", Name = "Accessory (LimbThree)", Offset = CFrame.Angles(0,0,math.rad(-90))}
        },

        ["Left Leg"] = {
            {Texture = "136752500636691", Mesh = "138744606849121", Name = "Accessory (LimbFour)", Offset = CFrame.Angles(0,0,math.rad(-90))}
        },
        
        ["Torso"] = {
            {Texture = "136752500636691", Mesh = "126825022897778", Name = "Accessory (TorsoBlack)", Offset = CFrame.identity}
        },
    },
